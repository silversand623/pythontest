...
if __name__ == "__main__":
    logchecker = logfile_checker(r'c:\\temp1\\lin1.log')


    logchecker.SearchInfile('ipaddress')
    logchecker.SearchInfile('timestamp')
    logchecker.SearchInfile('httpmethod')
    logchecker.SearchInfile('httpstatus')
    logchecker.SearchInfile('httpcontent')
    logchecker.SearchInfile('userAgent')
    logchecker.SearchInfile('httpurl')
